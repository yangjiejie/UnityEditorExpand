...
public class SceneViewUI
{
    ...
    private static void OnSceneGUI(SceneView sceneView)
    {
     ...
     "资源查重&合并");
        ...
        rect = new Rect(rect.x, rect.y - 20, 200, 20);
        if (GUI.Button(rect, "开启资源hook"))
        {
            SafeDeleteUnityResHook.forbidHook = !SafeDeleteUnityResHook.forbidHook;
            Debug.Log($"SafeDeleteUnityResHook.forbidHook= {SafeDeleteUnityResHook.forbidHook}");
        }
